...
IF "%1" == "--includes" echo -ID:/a/ODM/ODM/SuperBuild/install/include -ID:/a/ODM/ODM/venv/Lib/site-packages/osgeo/include/gdal -ID:/a/ODM/ODM/vcpkg/installed/x64-windows/include & goto exit
IF "%1" == "--cflags" echo /DWIN32 /D_WINDOWS /W3 & goto exit
IF "%1" == "--cxxflags" echo /DWIN32 /D_WINDOWS /W3 /GR /EHsc -std=c++11 & goto exit
IF "%1" == "--version" echo 2.4.3 & goto exit
