...
public:
	...
	static int image_max_size(const std::vector<Project::ImageType>& photos, double target_resolution, XString reconstruction_json, double gsd_error_estimate = 0.5,
