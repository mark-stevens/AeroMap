...
cv::Mat Thermal::resize_to_match(cv::Mat image, Project::ImageType match_photo)
{
...
cv::Mat Thermal::dn_to_temperature(Project::ImageType photo, cv::Mat image, XString images_path)
{
