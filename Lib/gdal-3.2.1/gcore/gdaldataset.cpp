...
#include "../raster_frmts/derived/derivedlist.h"
...
/*
This method attempts to create a new layer on the dataset with the
...
/*
Drop a reference to this dataset, and if the reference count drops to one
...
/*
 Return the layout of a dataset that can be considered as a raw binary format.
