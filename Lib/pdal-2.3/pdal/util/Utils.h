...
namespace pdal
{
	namespace Utils
	{
		...
		*/
		FILE* portable_popen(const std::string& command,
		...
		*/
		std::vector<std::string> wordWrap(std::string const& inputString,
		...
		/**
		  ...
		  \return  List of substrings generated from the input string.
		*/
		std::vector<std::string> wordWrap2(std::string const& inputString,
			size_t lineLength, size_t firstLength = 0);
