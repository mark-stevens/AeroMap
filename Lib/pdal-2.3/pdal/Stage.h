	...
	*/
	...
	private:
		...
		*/
		...
		friend std::istream& operator>>(std::istream& in, WhereMergeMode& mode);
		friend std::ostream& operator<<(std::ostream& out, const WhereMergeMode& mode);
	};
}
