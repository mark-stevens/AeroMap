...
namespace pdal
{
	...
	{
		args.add("min_points", "Minimum number of points in a tree cluster", m_minSize, point_count_t(10));
		args.add("min_height", "Minimum height above ground to start a tree cluster", m_minHag, 3.0);
		args.add("radius", "Dummy point located outside this approximate radius", m_dummyRadius, 100.0);
	}
	...
	void LiTreeFilter::classifyPoint(PointId ui, PointView& view, PointIdList& Ni, PointIdList& Pi)
	{
