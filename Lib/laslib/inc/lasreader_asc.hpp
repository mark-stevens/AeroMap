...
#ifndef LASREADERASC_HPP
#define LASREADERASC_HPP
...
public:
	...
	I32 get_format() const  override{ return LAS_TOOLS_FORMAT_ASC; };

	BOOL seek(const I64 p_index) override;

	ByteStreamIn* get_stream() const override;
